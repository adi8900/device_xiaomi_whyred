...
GOODIX="$AOSIP_ROOT"/vendor/"$VENDOR"/"$DEVICE"/proprietary/vendor/lib64/libgf_ca.so
...
sed -i 's/xml version="2.0"/xml version="1.0"/' "$BLOB_ROOT"/product/etc/permissions/vendor.qti.hardware.data.connection-V1.{0,1}-java.xml
